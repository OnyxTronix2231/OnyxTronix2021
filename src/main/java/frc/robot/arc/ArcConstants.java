...
public class ArcConstants {
    ...
    public static final double MOVE_ARC_TO_SWITCH_LIMIT_SPEED = -0.15; // TODO: check and change
    ...
    static final double MAX_POSSIBLE_ANGLE = 70 - OFFSET; // TODO: check and change
