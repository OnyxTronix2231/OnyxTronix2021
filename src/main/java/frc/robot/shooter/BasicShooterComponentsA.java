...
public class BasicShooterComponentsA implements ShooterComponents {
    ...
    public BasicShooterComponentsA() {
        masterMotor = new WPI_TalonFX(ShooterConstants.ShooterComponentsA.MASTER_MOTOR_ID);
        masterMotor.configFactoryDefault();
        masterMotor.configAllSettings(getFalconConfiguration());
        masterMotor.setNeutralMode(NeutralMode.Coast);
        masterMotor.setInverted(true);

        slaveMotor = new WPI_TalonFX(ShooterConstants.ShooterComponentsA.SLAVE_MOTOR_ID);
