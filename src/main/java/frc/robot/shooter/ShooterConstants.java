...
public final class ShooterConstants {
    ...
    public static final class ShooterConstantsA { //TODO: check all values on robot
        ...
        static final int ANGLE_MOTOR_MAX_ACCELERATION = 10;
        static final int ANGLE_MOTOR_ACCELERATION_SMOOTHING = 0; // 0 - 8
        ...
        static final int ANGLE_MOTOR_PEAK_AMP = 20;
        static final int ANGLE_MOTOR_PEAK_AMP_DURATION = 0;
        static final double ANGLE_MOTOR_OPEN_LOOP_RAMP = 1;
        static final int ANGLE_MOTOR_CONTINUOUS_CURRENT_LIMIT = 35;
