...
public final class ShooterConstants {
    ...
    public static final class ShooterConstantsA { //TODO: check all values on robot
        ...
        static final double ANGULAR_MOTOR_MAX_VELOCITY = 500; // Encoder Units
        ...
        static final double ANGULAR_MOTOR_VELOCITY_F = MAX_CLOSED_LOOP_OUTPUT / ANGULAR_MOTOR_MAX_VELOCITY;
