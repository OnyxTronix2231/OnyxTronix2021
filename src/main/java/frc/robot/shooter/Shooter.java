...
public class Shooter extends SubsystemBase {
  ...
  public boolean isOnTarget() {
    return Math.abs(components.getMasterMotor().getClosedLoopError()) < ShooterConstants.TOLERANCE;
  }

  public void configVelocitySlot() {
    components.getMasterMotor().selectProfileSlot(ShooterConstants.ShooterComponentsA.VELOCITY_PID_SLOT, PRIMARY_PID);
  }
