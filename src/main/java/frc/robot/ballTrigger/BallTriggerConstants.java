...
public final class BallTriggerConstants {
    ...
    static final double BALL_TRIGGER_CONVENTION = 6.25;
    static final double ENCODER_UNITS_PER_ROTATION = 4096 * BALL_TRIGGER_CONVENTION;
    ...
    public static final class BallTriggerConstantsA {
        ...
        static  final int PEAK_OUTPUT_REVERSE = -1;
